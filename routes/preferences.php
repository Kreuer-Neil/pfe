...
Route::patch('settings/preferences/languages', [UserPreferencesController::class, 'updateLanguages'])
    ->name('preferences.update.languages');
Route::patch('settings/preferences/tags', [UserPreferencesController::class, 'updateTags'])
